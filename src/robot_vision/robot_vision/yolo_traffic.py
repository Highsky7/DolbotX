...
class YoloVisionNode(Node):
    """
    A ROS2 node for object detection and drivable area segmentation using YOLO models.
    ...
    and for generating a drivable area mask via a YOLO segmentation model.
    ...
    yolo_model_path : str, default: './weights.pt'
        Path to the YOLO model file for drivable area segmentation.
    traffic_model_path : str, default: './traffic_light.pt'
        Path to the YOLO model file for traffic light detection.
    yolo_confidence : float, default: 0.7
        The minimum confidence threshold for the drivable area segmentation.
    drivable_class_index : int, default: 0
        The class index that represents the drivable area in the segmentation model.
    ...
    path_model : YOLO
        The YOLO model object for drivable area segmentation.
    ...
    mask_pub : rclpy.publisher.Publisher
        Publishes the drivable area mask image generated by the YOLO model.
...
def main(args=None):
    ...
    node = YoloVisionNode()
    print(YoloVisionNode.__doc__)  # Print the docstring of the class for reference
    try:
        rclpy.spin(node)
