...
class HsvPathPlanningNode(Node):
    def __init__(self):
        super().__init__('hsv_path_planning_node')
        self.get_logger().info("--- HSV Path Planning Node (Decoupled) ---")
        ...
        self.get_logger().info("✅ HSV Path Planning Node initialized successfully.")
