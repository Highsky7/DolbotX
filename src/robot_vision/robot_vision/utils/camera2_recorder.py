...
class VideoRecorder(Node):
    """
    Subscribe to /camera2/image_raw/compressed and record the stream to MP4.
    """
    def __init__(self):
        ...
        # Subscribe to /camera2/image_raw/compressed
        ...
        self.get_logger().info(f'Waiting for images on topic /camera2/image_raw/compressed...')
