#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FILE: springfall_drive.py (BEV-Removed Version)
# AUTHOR: Geoffrey Hinton (Modified by Gemini)
# DESCRIPTION:
# [Hinton's Logic Adapted for Camera-Space Control with Attentional ROI]
...
# 6. [Fail-Safe] 주행 영역 미감지 시 조향각 0도를 발행하여 안정성 확보 (원본 유지)
# 7. [핵심 수정] 지정된 ROI(관심 영역)를 원본 이미지에 직접 적용하여 노이즈 제거 및 안정성 극대화
