...
class HsvPathPlanningNode(Node):
    def __init__(self):
        ...
        self.get_logger().info("--- HSV Path Planning Node with Pure Pursuit Control ---")
        ...
        self.get_logger().info("✅ HSV Path Planning Node with Pure Pursuit initialized successfully.")
