...
# DESCRIPTION:
# ROI-aware Pure Pursuit planner that fuses three segmentation models.
...
# 9. Fuses drivable area, sand, and stone masks into a unified planning surface.
...
class YoloBevFusedDrivableAreaNode(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("--- YOLO BEV fused drivable-area planning node (ROI-optimized triple-fusion pipeline) ---")
